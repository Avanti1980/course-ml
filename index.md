...
<div class="noborder threelines outline head-highlight">

|     题目     |                            资料                            | 内容                                                                                    |
| :----------: | :--------------------------------------------------------: | :-------------------------------------------------------------------------------------- |
|     绪论     |                [slides](pages/origin.html)                 | 1. 机器学习的常见应用，机器学习算法是一种元算法                                         |
|      ^       |                             ^                              | 2. 图灵测试，达特茅斯会议                                                               |
|      ^       |                             ^                              | 3. 人工智能三次浪潮：推理期、知识期、学习期                                             |
| 机器学习定义 |              [slides](pages/definition.html)               | 1. 机器学习的常见任务类型：监督、半监督、无监督                                         |
...
|    决策树    |                  [slides](pages/dt.html)                   | 1. ID3 决策树，C4.5 决策树，分类回归树 (CART)                                           |
|      ^       |                             ^                              | 2. 信息增益，增益率，基尼指数                                                           |
|      ^       |                             ^                              | 3. 鸢尾花分类                                                                           |
|      ^       |                             ^                              | 4. 决策树剪枝                                                                           |
|    感知机    |                           &nbsp;                           | 1. M-P 神经元模型，激活函数                                                             |
|      ^       |              [slides](pages/perceptron.html)               | 2. 感知机模型与算法，实现与或非运算                                                     |
|      ^       |               [notes](notes/perceptron.pdf)                | 3. 感知机理论分析：Novikoff 定理                                                        |
...
|      ^       |                             ^                              | 4. 卷积神经网络，循环神经网络，注意力机制                                               |
|  朴素贝叶斯  |                  [slides](pages/nb.html)                   | 1. 贝叶斯决策论，贝叶斯风险，贝叶斯最优模型                                             |
|      ^       |                             ^                              | 2. 后验概率最大化：判别式方法，生成式方法                                               |
|      ^       |                             ^                              | 3. 朴素贝叶斯：条件独立性假设，极大似然估计                                             |
|      ^       |                             ^                              | 4. 拉普拉斯平滑                                                                         |
|  贝叶斯概率  |                 [slides](pages/bayes.html)                 | 1. 频率主义，最大似然 _vs._ 贝叶斯主义，最大后验                                        |
|      ^       |                             ^                              | 2. 共轭先验，二项式 - 贝塔，多项式 - 狄利克雷                                           |
|      ^       |                             ^                              | 3. 贝叶斯视角下的朴素贝叶斯、对率回归                                                   |
|      ^       |                             ^                              | 4. 贝叶斯视角下的线性回归：岭回归、LASSO                                                |
|    k-近邻    |                  [slides](pages/knn.html)                  | 1. k-近邻法，度量空间，度量学习                                                         |
|      ^       |                             ^                              | 2. 泛化错误率的渐进分析                                                                 |
|      ^       |                             ^                              | 3. 泛化错误率的非渐进分析                                                               |
|      ^       |                             ^                              | 4. 维度灾难                                                                             |
