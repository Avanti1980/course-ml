...
<span style="font-size:1.2em">$D_1$：时间 = 周六</span>
<span style="font-size:1.2em">$D_2$：时间 = 周日</span>
<span style="font-size:1.2em">$D_3$：时间 = 周间</span>

<p class="top-2">&emsp;</p>

$$
\begin{align*}
    H(D_1) & = - \frac{3}{6} \log \frac{3}{6} - \frac{3}{6} \log \frac{3}{6} = 1.000 \\
    H(D_2) & = - \frac{4}{6} \log \frac{4}{6} - \frac{2}{6} \log \frac{2}{6} = 0.918 \\
    H(D_3) & = - \frac{1}{5} \log \frac{1}{5} - \frac{4}{5} \log \frac{4}{5} = 0.722
\end{align*}
$$
...
$$
\begin{align*}
    \gain & (D, \text{时间}) = 0.998 - \frac{6}{17} \times 1.000 \\
    &  - \frac{6}{17} \times 0.918 - \frac{5}{17} \times 0.722 = 0.109
\end{align*}
$$
...
<span style="font-size:1.2em">$D_1$：方式 = 吃饭</span>
<span style="font-size:1.2em">$D_2$：方式 = 逛街</span>
<span style="font-size:1.2em">$D_3$：方式 = 学习</span>
...
<span style="font-size:1.2em">$D_1$：天气 = 晴天</span>
<span style="font-size:1.2em">$D_2$：天气 = 阴天</span>
<span style="font-size:1.2em">$D_3$：天气 = 雨天</span>
...
<span style="font-size:1.2em">$D_1$：课业 = 轻松</span>
<span style="font-size:1.2em">$D_2$：课业 = 正常</span>
<span style="font-size:1.2em">$D_3$：课业 = 繁重</span>
...
<span style="font-size:1.2em">$D_1$：疫情 = 清零</span>
<span style="font-size:1.2em">$D_2$：疫情 = 平缓</span>
<span style="font-size:1.2em">$D_3$：疫情 = 严峻</span>
...
<span style="font-size:1.2em">$D_1$：电视 = 精彩</span>
<span style="font-size:1.2em">$D_2$：电视 = 无聊</span>
