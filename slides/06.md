...
$$
\begin{align*}
    \qquad \Pbb(y = +1 | \xv) &  = \sigma(\wv^\top \xv) = \frac{1}{1 + \exp(-\wv^\top \xv)} \\
...
$$
\begin{align*}
    \qquad \wv^\top \xv = \ln \frac{\Pbb(y = +1 | \xv)}{\Pbb(y = -1 | \xv)} = \ln \frac{\sigma(\wv^\top \xv)}{1 - \sigma(\wv^\top \xv)}
\end{align*}
$$
...
$$
\begin{align*}
    \qquad \Pbb(y = +1 | \xv) & = \sigma(\wv^\top \xv) \\
    \Pbb(y = -1 | \xv) & = 1 - \sigma(\wv^\top \xv) = \sigma(-\wv^\top \xv)
\end{align*}
$$
...
$$
\begin{align*}
    \qquad \ln \prod_{i \in [m]} \Pbb(y_i | \xv_i) = \sum_{i \in [m]} \ln \sigma(y_i \wv^\top \xv_i) = \sum_{i \in [m]} \ln \frac{1}{1 + \exp(- y_i \wv^\top \xv_i)}
\end{align*}
$$
...
$$
\begin{align*}
    \qquad \ln \prod_{i \in [m]} \Pbb(y_i | \xv_i) & = \sum_{i \in [m]} \ln \class{blue}{\sigma(\wv^\top \xv_i)^{y_i} \sigma(-\wv^\top \xv_i)^{1 - y_i}} \\
