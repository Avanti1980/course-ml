...
### <span class="fragment">机器学习算法是一种{==元算法==} (meta algorithm)</span>
...
> <span style="font-size:1.4em;font-weight:900">寻龙诀</span><br>寻龙分金看缠山，一重缠是一重关，关门如有八重险，不出阴阳八卦形。发丘印，摸金符，搬山卸岭寻龙诀；人点蜡，鬼吹灯，勘舆倒斗觅星峰；水银癍，养明器，龙楼宝殿去无数；窨沉棺，青铜椁，八字不硬莫近前。入口为马，马为离卦；子鼠遇马为坎离；未羊遇马为坤离；戌狗遇马为乾离，上乾下离见生门。
...
- 1959 年王浩证明了《数学原理》中的 150 条一阶逻辑定理和 200 条命题逻辑定理，关于高阶逻辑复杂性的研究引出学生库克的 NP 理论
