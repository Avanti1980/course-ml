...
\begin{tikzpicture} [scale=0.8]
    ...
    \node [nc,fill=SolarizedBase1] (concatenate) at (1,-3.5) {$+$};
    ...
    \draw [dashed,very thick,SolarizedBlue] (-0.5,-5) -- (17,-5) -- (17,6) -- (-0.5,6) -- (-0.5,-5);

    \node [nc,label={[inner sep=6pt,SolarizedBase01]right:\large 向量元素乘}] at (4,-6.5) {$\times$};

    \node [nc,label={[inner sep=6pt,SolarizedBase01]right:\large 向量和}] at (9,-6.5) {$+$};

    \node [nc,fill=SolarizedBase1,label={[inner sep=6pt,SolarizedBase01]right:\large 向量拼接}] at (13,-6.5) {$+$};
