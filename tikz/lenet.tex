...
\begin{tikzpicture}
    ...
    \node [Solarized-base01] at (-5,1.55) {$32 \times 32$};

    \node [Solarized-base01] at (-2,1.8) {$6~@~28 \times 28$};
    ...
    \node [Solarized-base01] at (2.4,-2.1) {$6~@~14 \times 14$};
    ...
    \node [Solarized-base01] at (3.5,1.5) {$16~@~10 \times 10$};
    ...
    \node [Solarized-base01] at (7.4,-1.8) {$16~@~5 \times 5$};
