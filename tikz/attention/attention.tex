...
\begin{tikzpicture}
    ...
    \node (s) [roundbox] at (-1.5, \yarray[2]) {$\mathrm{softmax}$};
    ...
    \foreach \i in {1,2,4}
        {
            ...
            \draw [arrow] (a\i) -- (t\i);
            \draw [arrow] (t\i) -- (add);
            \draw [arrow,SolarizedYellow,dashed] (x\i) -- ++(1.2, 0) -- ++(0, 5.4) -- (t\i);
        }

    \draw [arrow] (add) -- (c);

    \draw [SolarizedBlue,dashed] (q) -- (\qxarray[2], \qy);

    \draw [arrow,SolarizedBlue,dashed] (\qxarray[0], \qy) -- ($(s1.south east)!(\qxarray[0], \qy)!(s1.south)$);
    \draw [arrow,SolarizedBlue,dashed] (\qxarray[1], \qy) -- ($(s2.south east)!(\qxarray[1], \qy)!(s2.south)$);
    \draw [arrow,SolarizedBlue,dashed] (\qxarray[2], \qy) -- ($(s4.south east)!(\qxarray[2], \qy)!(s4.south)$);
