...
;(function () {
  ...
  function expandConfig (config) {
    ...
    if (!config.hasOwnProperty('pieceTheme') ||
      ...
      config.pieceTheme = '../js/xiangqiboardjs-0.3.3/img/xiangqipieces/wikimedia/{piece}.svg'
    }

    // default board theme is wikimedia
    if (!config.hasOwnProperty('boardTheme') || !isString(config.boardTheme)) {
      config.boardTheme = '../js/xiangqiboardjs-0.3.3/img/xiangqiboards/wikimedia/xiangqiboard.svg'
    }
